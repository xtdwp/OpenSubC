...
// Error codes
int OPENSUBC_E_UNASSIGNED{ -1 };
int OPENSUBC_E_ALLOCATE{ -2 };
int OPENSUBC_E_OUT_OF_BOUNDS{ -3 };
int OPENSUBC_E_INVALID_SIZE{ -4 };
int OPENSUBC_E_INVALID_ARGUMENT{ -5 };
int OPENSUBC_E_INVALID_TYPE{ -6 };
int OPENSUBC_E_INVALID_ID{ -7 };
int OPENSUBC_E_GEOMETRY{ -8 };
int OPENSUBC_E_DATA{ -9 };
int OPENSUBC_E_PHYSICS{ -10 };
int OPENSUBC_E_WARNING{ 1 };

// Error message
char opensubc_err_msg[256];
