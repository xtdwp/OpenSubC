...
void opensubc::output(double t)
{
	...
	for (auto& channel : channels)
	{
		...
		{
			cout << setiosflags(ios_base::left) << setw(15) << h.coeffRef(i) << setw(15) << rho.coeffRef(i) << setw(15) << P(i) << setw(15) << m.coeffRef(i) << setw(15) << T.coeffRef(i) << setw(15) << Tw.coeffRef(i)<<endl;
		}
